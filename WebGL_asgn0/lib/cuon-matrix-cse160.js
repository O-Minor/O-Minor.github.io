...
class Vector3 {
    ...
    static dot(other1, other2) {
        ...
        let d = (v1[0]*v2[0])+
                (v1[1]*v2[1])+
                (v1[2]*v2[2]); // Modify this line to calculate this vector's magnitude.
    ...
    static cross(other1, other2) {
        ...
        //citation of forumula for ref
        //https://d138zd1ktt9iqe.cloudfront.net/media/seo_landing_files/image-1676266798.png
        // Don't delete the return statement.
        return v3;
    }

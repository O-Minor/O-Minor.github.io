...
function drawTriangle3D_UV_Normal(vertices, uv, normals) { 
    var n = vertices.length/3; // The number of vertices
    ...
    if(!normalBuffer){
        console.log('failed to make normal Buffer object');
        return -1;
    }
    ...
    // atrib pointer makes it so you can pass multiple things (now 3 for x y z)
    gl.vertexAttribPointer(a_Normal, 3, gl.FLOAT, false, 0, 0); //for normal render()
    // Enable the assignment to a_Position variable
